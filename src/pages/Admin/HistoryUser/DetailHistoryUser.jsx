...
export default class DetailHistoryUser extends Component {
  constructor(props) {
    super(props);
        ...
        <div className="wrapper">
          ...
          <div className="main">
            ...
            <div className="mt-3" style={{ marginLeft: "20px" }}>
              <Link className="text-decoration-none" to="/admin-history">
                  ...
                  <>
                    ...
                    <div id="Matrix Ternormalisasi">
                      ...
                      <div className="fw-bold" style={{ marginLeft: "50px" }}>
                        ...
                        <ul>
                          <li>
                            X<sub>ij</sub> adalah nilai Alternative i pada
                            Criteria j.
                          </li>
                    ...
                    <div id="Matrix Ternormalisasi Terbobot">
                      ...
                      <div className="fw-bold" style={{ marginLeft: "50px" }}>
                        ...
                        <ul>
                          ...
                          <li>n adalah jumlah Alternative.</li>
                          <li>
                            W<sub>j</sub> adalah bobot (weight) untuk Criteria
                            j.
                          </li>
                        </ul>
                      </div>
                    ...
                    >
                      ...
                      <div className="fw-bold" style={{ marginLeft: "50px" }}>
                        ...
                        <ul>
                          <li>
                            Y<sub>j</sub> adalah nilai hasil terbobot untuk
                            Criteria j.
                          </li>
                    ...
                    <div style={{ marginTop: "50px" }} id="Jarak ideal positif">
                      <h5 className="fw-bold" style={{ marginLeft: "30px" }}>
                        Jarak Antara Nilai Terbobot setiap alternatif untuk
                        Solusi Ideal Positif
                      </h5>

                      <div className="fw-bold" style={{ marginLeft: "50px" }}>
                        <p>
                          Jarak Antara Nilai Terbobot untuk Solusi Ideal Positif
                          (D
                          <sup>+</sup>):
                        </p>
                        <p>
                        ...
                        <ul>
                          <li>
                            D<sub>i</sub>
                            <sup>+</sup> adalah jarak antara Alternative i
                            dengan Solusi Ideal Positif.
                          </li>
                          <li>
                            X<sub>ij</sub> adalah nilai terbobot untuk
                            Alternative i pada Criteria j.
                          </li>
                          <li>
                            A<sup>+</sup>
                    ...
                    <div style={{ marginTop: "50px" }} id="Jarak ideal negatif">
                      ...
                      <div className="fw-bold" style={{ marginLeft: "50px" }}>
                        <p>
                          Jarak Antara Nilai Terbobot untuk Solusi Ideal Negatif
                          (D
                          <sup>-</sup>):
                        </p>
                        <p>
                    ...
                    <div style={{ marginTop: "50px" }} id="Hasil Topsis">
                      ...
                      <div className="fw-bold" style={{ marginLeft: "50px" }}>
                        <p>
                          Kedekatan Alternatif i terhadap Solusi Ideal (V
                          <sub>i</sub>
                          ):
                        </p>
                        <p>
                        ...
                        <ul>
                          <li>
                            V<sub>i</sub> adalah nilai kedekatan untuk
                            Alternative i terhadap Solusi Ideal.
                          </li>
                          <li>
                            D<sub>i</sub>
                            <sup>-</sup> adalah jarak antara Alternative i
                            dengan Solusi Ideal Negatif (A-).
                          </li>
                          <li>
                            D<sub>i</sub>
                            <sup>+</sup> adalah jarak antara Alternative i
                            dengan Solusi Ideal Positif (A+).
                          </li>
                        </ul>
                      </div>
